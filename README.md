...
Die App besteht aus statischen Dateien. `index.html` kann direkt im Browser geöffnet oder über einen lokalen Webserver bereitgestellt werden.
...
Das Projekt kann ohne Build-Schritt auf Netlify veröffentlicht werden. Als Veröffentlichungsverzeichnis dient das Stammverzeichnis des Repositorys.
